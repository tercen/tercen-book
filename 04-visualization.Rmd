...
__Multi-pairwise__ is configured in the cross-tab window. It is created by dragging-n-dropping the same factor in the ``row`` zone and in the ``column`` zone. Note, a factors requires to be defined in the ``label zone``. This allows the projection to know what factor separates data points in the pairwise. 
...
Here are a few examples view configuration examples.
