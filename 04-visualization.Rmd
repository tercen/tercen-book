...
The cross-tab window is opened by double clicking on a __data step__ in a __workflow__. The cross-tab window allows the researchers to create any visual by dragging-n-dropping factors to the appropiate section of the cross-tab window.
