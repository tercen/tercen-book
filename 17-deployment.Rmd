...
Currently the cloud is running the beta version of __Tercen__.
...
The server version is for a on-site server install. It is packaged as a docker version. The current version runs Linux, Mac, Windows.
