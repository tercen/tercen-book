...
* created by an __admin__
* a set of __users__ (i.e. researchers)
* a set of __apps__ (called __my library__)
...
A __user__ (i.e. reasearcher) may be a member of many __teams__ and therefore access many __projects__.
