...
### Download the data 
It is found at https://github.com/tercen/crabs/data and download to your local drive
...
_TercenCloud_ accepts data in either _tsv_ or _csv_. These data set is in a tsv and is in a _long format_.
...
The _projection_ page is composed of different zones. The main zones are highlighted in green below:
...
The save icon (see red circle in figure below) will dissappear once it is saved 
...
### Click on the data step and select **Add step** 
...
### Drag-n-drop the ``index`` and ``species`` factor to the _label zone_
