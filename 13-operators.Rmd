...
## Creating operators {-}
Tercen allows programmers to easily build new operators from the comfort of their favorite interactive development environment (IDE). From the IDE it is possible to access all Tercen features. Access the input data and returning results is essential when developing your __operator__ in the IDE on your local machine.  

The ability to create a new Tercen operator requires basic programming skills and is straight forward.

Here is a development workflow to create an __operator__:
...
__Writing and testing the operator__:

* Develop and test the __operator__ within the `workspace.R` file
* Determine the input data for the __operator__
    ...
    + Execute the __operator__ locally 
    + Push results back to Tercen using the tercen API `tercen::ctx$save`
  
The actions above may happen multiple times as you develop your operator. Once the __operator__ is finalized then proceed:
...
* Download the zip of the __step__
* Unzip the folder
* Add `README.md` file
* Add `.gitignore` file
* Create a git repository for the new __step__
* Upload the files to the new __step__ git repository
...
* Download the zip of the  __workflow__
* Unzip the folder
* Add `README.md` file
* Add `.gitignore` file
* Create a git repository for the new __workflow__ git repository
* Upload the files to the new __workflow__ git repository
